<section class="fnavbar">
		...
		<nav>
		    <div class="nav-wrapper">
		      <a href="#" class="brand-logo">Go Restro</a>
		      <a href="#" data-target="mobile-demo" class="sidenav-trigger"><i class="material-icons">menu</i></a>
		      <ul class="right hide-on-med-and-down">
		        <li><a href="./" class="hvr-grow">Home</a></li>
		        <li><a href="./about-go-restro.php" class="hvr-grow">About Us</a></li>
		        <li><a href="./food-categories.php" class="hvr-grow">Categories</a></li>
		        <li><a href="./foods.php" class="hvr-grow">Foods</a></li>
		        <li><a href="#" class="hvr-grow" onclick="toggleModal('Contact Info', 'You can contact us directly by calling to this number +91255486265525. Check the bottom Footer Section of the website for more info.');">Contact</a></li>
		  ...
		  <ul class="sidenav" id="mobile-demo">
		    <li><a href="./">Home</a></li>
	        <li><a href="./about-restro-girls.php">About Us</a></li>
