	...
	<div class="container">
		...
		<?php
			...
			if (isset($_SESSION['msg'])) {
				echo '<div class="section blue center" style="margin: 10px; padding: 3px 10px; margin-top: 35px; border: 2px solid black; border-radius: 5px; color: white;">
			...
			<div class="col s12 m4">
				<div class="card">
			        ...
			        <div class="card-content center">
			          <a href="backends/order-food.php?id=<?php echo $arr_all[$i+$j-2]['id']; ?>" style="background: #40c1e9;" class="btn waves-effect waves-block waves-light" href="">Order Now!</a>
			        </div>
				    </div>
